...
import net.smart.web.plugin.jira.rest.internal.client.AsynchronousExtendedIssueRestClient;
import net.smart.web.plugin.jira.rest.internal.client.AsynchronousExtendedMetadataRestClient;
...
public class RestClientManager {
	...
	private RestClientFactory clientFactory = null;
	 ...
	 * @param trustStorePassword the SSL trust store password (null, if no password required)
	 * @throws URISyntaxException the uRI syntax exception
	 */
	public RestClientManager(String serverUri, String username, String password, String trustStorePath, String trustStorePassword) throws URISyntaxException {
		...
		this.jiraRestClient = this.clientFactory.createJiraClient(serverUri, username, password);
		...
		DisposableHttpClient httpClient = new AsynchronousHttpClientFactory().createClient(new URI(serverUri), new BasicHttpAuthenticationHandler(username, password));
