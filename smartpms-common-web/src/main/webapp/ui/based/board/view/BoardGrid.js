var _data;
Ext.define('Ui.based.board.view.BoardGrid' ,{
    ...
    initComponent: function() {
        ...
        { 
            header: '<span class="right-icon hot-icon x-fa fa-file-o"></span>',
            width: 50,
            align:'center',
            dataIndex : 'fileView',
            renderer : function(value) {
            	return '<span class="right-icon hot-icon x-fa fa-file-o"  style="cursor:pointer;cursor:hand;"></span>';
            }
        }
        ];
